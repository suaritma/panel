<?php
  ...
  <form role="form" method="post">
    ...
    <div class="modal-body">
      <div class="form-group"><input placeholder="Kategori Adı" class="form-control" name="title" type="text" value="<?=$res['title']?>"></div>
      <div class="form-group"><select class="form-control m-b" name="status"><option value="1"<?php if ($res['status']==1) { ?> checked<?php } ?>>Aktif</option><option value="0"<?php if ($res['status']==0) { ?> checked<?php } ?>>Pasif</option></select></div>
    </div>

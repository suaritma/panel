...
<html lang="en">
    <head>
        ...
        <link href="<?=ADMIN_URL?>_assets/css/waves.min.css" type="text/css" rel="stylesheet"><link rel="stylesheet" href="css/nanoscroller.css">
        ...
        <div class="container">
            <div class="row">
                <div class="account-col text-center">
                    <img src="<?=ADMIN_URL?>_assets/logo.png" />
                    <h3>&nbsp;</h3>

      ...
      <div class="alert alert-info">
        ...
        <div class="panel panel-card margin-b-30">
            <div class="panel-body" >
                <div id="accordion">
                    <h3>Montaj Bildirim - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka], [cihaz_fiyat] )</span></h3>
                    <div>
                    ...
                    <h3>Servis Bakım Bildirim - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka], [cihaz_fiyat], [servis_fiyat] )</span></h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">
                    ...
                    <h3>Bayram / Özel Gün Bildirim</h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">
                    ...
                    <h3>Servis Periyodu Bildirim - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka] )</span></h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">

      ...
      <div class="alert alert-info">
        ...
        <div class="panel panel-card margin-b-30">
            <div class="panel-body" >
                <div id="accordion">
                    <h3>Montaj E-Posta - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka], [cihaz_fiyat] )</span></h3>
                    <div>
                    ...
                    <h3>Servis Bakım E-Posta - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka], [cihaz_fiyat], [servis_fiyat] )</span></h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">
                    ...
                    <h3>Servis Periyodu E-Posta - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [cihaz_isim], [cihaz_marka] )</span></h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">
                    ...
                    <h3>Ödeme E-Posta - <span style="font-size:10px"><strong>Özel Değişkenler</strong> ( [odeme_tutari], [odeme_komisyon], [odeme_aktarilan], [odeme_taksit] )</span></h3>
                    <div>
                      <div class="tabs-container">
                          <ul class="nav nav-tabs">

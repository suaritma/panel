...
// Tahminimce Müşteriye taksit girma alanı 
...
if ((isset($_POST['process'])) && ($_POST['process']=="device_add")) {
  if ($_SESSION['p3']['padd']!=1) {
    ...
    if (!isset($error)) {
      ...
      $add=mysqli_query($con, "INSERT INTO `customers_device` VALUES ('','$id','$device_id','$urun_serino','$cihaz_adresi','$cihaz_bedeli','$description','$created_at','0','0','1')");
      if ($add) {
        $error = '2006';
      } else {
        $error = '1020';
...
// Taksitle alakalı ama tam anlamadım tahminimce ödenmeyen taksitler 
...
// müşterinin personellerini silme 
...
// personel mesaj ayarları sanırım 

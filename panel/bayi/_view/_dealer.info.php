...
<div class="col-md-6">
    <ul class="list-group">
        <li class="list-group-item">
            <p><?=$lang['dealer_name']?>: <b><?=$dealer['title']?></b></p>
        </li>
        <li class="list-group-item">
            <p><?=$lang['dealer_code']?>: <b><?=$dealer['dealer_code']?></b></p>
        </li>
        <li class="list-group-item">
            <p><?=$lang['dealer_phone']?>: <b><?=$dealer['gsm']?></b></p>
        </li>
        <li class="list-group-item">
            <p><?=$lang['dealer_website']?>:
                <b>
        ...
        <li class="list-group-item">
            <p><?=$lang['dealer_address']?>: <b><span id="get_customer_address"><?=$dealer['city']?>-<?=$dealer['town']?>-<?=$dealer['district']?>-<?=$dealer['street']?></span><span>, <?=$dealer['address']?></span> </b></p>
        </li>
        <a href="<?=DEALER_URL?>customers/list"
           class="list-group-item">
            <p class="underline">
                <?=$lang['dealer_customers']?>:
                <b><?=$count_customers?></b>
            </p>
        </a>

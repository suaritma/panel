...
!1,s=!1;"undefined"===typeof ra.Chart.creditHref?(m.creditHref=ja("iuuqr;..b`ow`rkr/bnl."),m.creditText=ja("B`ow`rKR/bnl")):(q=m.updateOption("creditText"),s=m.updateOption("creditHref"));if(m.creditHref&&m.creditText){m._creditLink||(m._creditLink=document.createElement("a"),m._creditLink.setAttribute("class","canvasjs-chart-credit"),m._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;display:none;right:2px;top:"+(m.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
...
savePNGText:"PNG olarak kaydet",printText:"Print",days:"Pazar Pazartesi Salı Çarşamba Perşembe Cuma Cumartesi".split(" "),shortDays:"Pz Pzt Sal Çar Per Cum Cmt".split(" "),months:"Ocak Şubat Mart Nisan Mayıs Haziran Temmuz Ağustos Eylül Ekim Kasım Aralık".split(" "),shortMonths:"Ock Şub Mar Nis May Haz Tem Ağu Eyl Eki Kas Ara".split(" ")}},Ka={en:{}},x=v?"Trebuchet MS, Helvetica, sans-serif":"Arial",Fa=v?"Impact, Charcoal, sans-serif":"Arial",Aa={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),
